...
block_iteration_range = op.block_max_iter;

if length(block_iteration_range)<2
    block_iteration_range(end+1) =block_iteration_range(1);
end
if length(block_iteration_range)<3
    block_iteration_range(end+1) =1;
end
optimization_spec = struct('solver_num',1,...
                        ...
                        'block_iteration_range',block_iteration_range,...
                        'cycle_num',op.cycle_num);
